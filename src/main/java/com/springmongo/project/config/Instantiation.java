...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2024"), "Partiu viagem", "Vou viajar para Irlanda", maria);
        Post post2 = new Post(null, sdf.parse("23/03/2024"), "Bom dia", "Felicidade para geral", maria);
